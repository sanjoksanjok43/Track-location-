...
<script>
// Default view set to Nepal Coordinates (Kathmandu)
let map = L.map('map').setView([27.7172, 85.3240], 7);
...
def fetch_data(number):
    try:
        # Note: The third-party API endpoint remains the same as provided.
